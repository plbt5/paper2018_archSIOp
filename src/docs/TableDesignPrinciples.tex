...
\quad When it is reasonable to expect that the software agent will be engaged in collaboration or otherwise will interoperate with (an)other software agent(s), it is the responsibility of the DSP and the DSC to enable to establish the extent of their semantic compatibility by explicating and disclosing their OCs. Additionally, it is the responsibility of the DSP to disclose the semantic meaning of the exchanged data to allow their comprehension by the DSC. 
\end{mmdp}
&
\begin{description}[labelwidth=3.7cm,leftmargin=3.7cm+1ex,nosep,topsep=2ex,labelsep=1ex,font=\bfseries]
  \item[Type of information:] Business, Data;
